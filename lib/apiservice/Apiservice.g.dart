...
class _RestClient implements RestClient {
  _RestClient(this._dio, {this.baseUrl}) {
    baseUrl ??= 'https://rasthetique.com/public/api/';
  }
  ...
  @override
  Future<bookingResponse> booking(salon_id, emp_id, service_id, payment, date,
  ...
  @override
  Future<empResponse> selectemp(start_time, service, date, salon_id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _data = {
        ...
        _setStreamType<appointmentResponse>(
            Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, 'appointment',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    print(_result.data!['data']['cancel']);
  ...
  @override
  Future<checkCouponResponse> addreview(message, rate, booking_id,salon_id) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _data = {'message': message, 'rate': rate, 'booking_id': booking_id,'salon_id':salon_id};
    _data.removeWhere((k, v) => v == null);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<checkCouponResponse>(Options(
                method: 'POST',
