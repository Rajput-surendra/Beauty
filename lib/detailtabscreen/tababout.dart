...
import 'package:barber/detailtabscreen/website.dart';
import 'package:barber/screens/directiondestination.dart';
...
class _TabAbout extends State<TabAbout> {
  ...
  void initState() {
    ...
    if(widget.salonData!=null){
      if (mounted) {
        setState(() {
          double salon_lat = widget.salonData.latitude.toString()!=null?double.parse(widget.salonData.latitude):22.336346;
          double salon_long = widget.salonData.longitude.toString()!=null?double.parse(widget.salonData.longitude):72.78757;
