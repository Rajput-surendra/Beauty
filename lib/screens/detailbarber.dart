...
import 'package:barber/common/inndicator.dart';
import 'package:barber/constant/appconstant.dart';
import 'package:barber/constant/preferenceutils.dart';
import 'package:barber/detailtabscreen/galleryview.dart';
import 'package:barber/detailtabscreen/reviewtab.dart';
import 'package:barber/detailtabscreen/servicetab.dart';
import 'package:barber/detailtabscreen/tababout.dart';
...
class _DetailBarber extends State<DetailBarber>
  ...
  void SalonDetails()async {
    ...
    Map param ={
      "salon_id" :widget.catId.toString(),
    };
    var data = await apiBaseHelper.postAPICall("viewSalon", param, "");
    print(data['data']['category']);
    var response = salonDetailResponse.fromJson(data);
    setState(() {
      _loading = false;
      ...
      if (response.success = true) {
        ...
        if (response.data!.category!.length > 0) {
          print("bhai"+response.data!.category!.toString());
          categorylist.clear();
