...
import 'package:barber/screens/otpscreen.dart';
import 'package:barber/screens/registerScreen.dart';
  ...
  CallApiForLogin(String? email, String? password) async {
    ...
    RestClient(Retro_Api().Dio_Data())
      ...
      if (sucess == true) {
        ...
        print("login123:$login123 $body['data']");
        toastMessage("login successfully");

        print("WidgetIndex:${widget.index}");
        PreferenceUtils.setString(AppConstant.userid, body['data']['id'].toString());
        ...
        if (widget.index == 6) {
          ...
          Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => BottomBar(widget.index)));
        }
